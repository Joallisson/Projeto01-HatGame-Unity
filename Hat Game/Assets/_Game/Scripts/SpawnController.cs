...
public class SpawnController : MonoBehaviour
{
    ...
    { //Acontecer em determinado intervalo de tempo
        yield return new WaitForSeconds(2.0f); //o que estiver abaixo desta linha vai acontecer depois de 2 segundo, e o que estiver antes dessa linha vai acontecer instantâneamente
